const local: App.I18n.Schema = {
  ...
  page: {
    ...
    ui: {
      ...
      oauthPkceRequired: 'Requerir PKCE (recomendado)',
      oauthPkceRequiredHint: 'Desactívalo solo para clientes de servidor antiguos que no implementen PKCE.',
      legacyCompatibility: 'Compatibilidad heredada',
      ...
      allUsersAccessNotice: 'Todos los usuarios con sesión iniciada pueden ver este sistema; las restricciones por roles no se aplican. Selecciona el acceso por roles para limitarlo a roles específicos.',
      ...
      permissionModuleSystem: 'Administración del sistema',
      permissionModuleOther: 'Otras funciones',
      ...
      dingTalkUserId: 'userId de DingTalk',
      roles: 'Roles',
      password: 'Contraseña',
      ...
      dingTalkSubjectPlaceholder: 'Ingresa el unionId devuelto por OAuth de DingTalk',
      dingTalkUserIdPlaceholder: 'Ingresa el userId del empleado de DingTalk (auxiliar)',
