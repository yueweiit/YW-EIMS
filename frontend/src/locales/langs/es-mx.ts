const local: App.I18n.Schema = {
  ...
  route: {
    ...
    system_user: 'Usuarios',
    'system_erpnext-sync-log': 'Registros de sincronización ERPNext',
    'system_oauth2-client': 'Aplicaciones OAuth2',
    'system_oauth2-binding': 'Vinculación de cuentas OAuth2',
    'system_external-system': 'Catálogo de sistemas externos',
    'system_audit': 'Auditoría de seguridad',
    system_permission: 'Permisos funcionales',
    system_role: 'Gestión de roles',
    material: 'Materiales',
