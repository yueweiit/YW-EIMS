  ...
  page: {
    login: {
      ...
      shell: {
        ...
        methods: 'Elige cómo iniciar sesión',
        scanTab: 'QR de DingTalk',
        passwordTab: 'Contraseña',
        scanTitle: 'Escanea con DingTalk para entrar',
        passwordTitle: 'Inicia sesión con tu cuenta',
        userName: 'Usuario',
        password: 'Contraseña',
        signIn: 'Iniciar sesión',
        signingIn: 'Iniciando sesión…',
        scanHint: 'Abre DingTalk en tu celular, escanea y confirma',
        qrLoading: 'Cargando el código QR de DingTalk…',
        qrFailed: 'No se pudo cargar el código QR',
        qrFailedHint: 'Inténtalo de nuevo o abre la autorización de DingTalk',
