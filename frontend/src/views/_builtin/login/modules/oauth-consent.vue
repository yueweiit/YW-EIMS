...
const clientName = computed(() => (route.query.client_name as string) || '第三方应用');
...
function handleAuthorize() {
  ...
  // Submit via form POST to the backend authorize endpoint
  const form = document.createElement('form');
  form.method = 'POST';
  form.action = `${baseURL}/oauth/authorize`;
...
<template>
  <div class="oauth-consent">
    ...
    <NSpace vertical :size="16">
      ...
      <NButton size="large" round block @click="handleDeny">
        拒绝
      </NButton>
    </NSpace>
